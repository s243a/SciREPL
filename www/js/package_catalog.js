...
class PackageCatalog {
    ...
    get builtinPackages() {
        return [
            ...
            {
                id: 'csv-basics-seedlings',
                name: 'CSV Basics: Seedling Heights',
                notebookName: 'CSV Basics: Seedling Heights',
                description: 'Create and read a small fictional CSV, then compare group averages with Python’s standard library.',
                type: 'workbook',
                revision: 1,
                format: 'srwb',
                pages_url: 'workbooks/csv-basics-seedlings.srwb',
                size: '~3 KB',
                kernels: ['python'],
                locales: ['en'],
            },
