# Landscape tutorial screenshots
...
- `pro-full-screen-editor.png`: full-screen saved-cell editor above the keyboard.

The text and controls are in English. The exact keyboard, Android navigation style, and available height depend on the device. The screenshots deliberately contain no personal workbook content or credentials. Keep the source images intact when adding callouts: a separate SVG overlay can be edited without altering these originals.
